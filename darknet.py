...
def get_test_input():
    img = cv2.imread("/home/alupotto/projects/pytorch-yolo-v3/dog-cycle-car.png")
...
#dn = Darknet('/home/alupotto/projects/pytorch-yolo-v3/cfg/yolo.cfg')
#dn.load_weights("yolov3.weights")
#inp = get_test_input()

#pred = dn(inp,torch.cuda.is_available())
#a, interms = dn(inp)
#dn.eval()
