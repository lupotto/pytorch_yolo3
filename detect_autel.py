...
#    model(get_test_input(inp_dim, CUDA), CUDA)
    ...
    torch.cuda.empty_cache()
        ...
        #TODO: Finetune:
    #       1. preparar batches amb path de imagen
    #       2. 16 images x batch
    #       3. Dins loop: 3.1 Llegir cada element del batch
    #                     3.2 Passarho a matrius
    #                     3.3 Batch a dins de la xarxa